...
from customer) and discount_applied='Yes';
...
--Segmentation of customers into New, Returning and loyal based on their total number of previous purchases and showing the count of each segment
